...
public class BatManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            _bats[i].catPosition = _playerTransform.position;
    ...
    private void CreateReactions(BatW6 bat)
    {
        ...
        //      of CreateReactions.
        SpawnReactionUI(bat, _messages[UnityEngine.Random.Range(0, _messages.Length - 1)]);
        // STEP 5 -------------------------------------------------------------
    }
    ...
    private void SpawnReactionUI(BatW6 bat, string message)
    {
        ...
        int index = Array.IndexOf(_bats, bat);
